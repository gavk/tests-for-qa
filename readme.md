...
https://vladivostok.hh.ru/vacancy/37516194

# Тестовые задания для Java junior
...
реализуйте метод
 ...
 ```
класса MethodInterception, таким образом, чтобы проходил тест:
``` java
...
Реализуйте перехват параметров аннотации TestMethodInfo  в тестовом методе и вывод их в консоль. Подключение TestNg Listener нужно сделать через ServiceLoader. 
 ``` java
